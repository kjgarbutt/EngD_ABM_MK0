...
public class Agent implements Steppable
{
    ...
    public Agent(EngDModelBuilder engDModelBuilder)
    {
        ...
        int walkway = engDModelBuilder.random.nextInt(EngDModel.roads.getGeometries().numObjs);
        MasonGeometry mg = (MasonGeometry) EngDModel.roads.getGeometries().objs[walkway];
        ...
        basemoveRate *= Math.abs(engDModelBuilder.random.nextGaussian());
    ...
    */
    private void findNewPath(EngDModel geoTest)
    {
    ...
    {
    	EngDModel campState = (EngDModel) state;
        move(campState);
//        campState.agents.setGeometryLocation(getGeometry(), pointMoveTo);
     ...
     */
    private void move(EngDModel geoTest)
    {
